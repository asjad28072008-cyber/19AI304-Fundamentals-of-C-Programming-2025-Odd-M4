...
void validateDate() {
    ...
    if (mm == 1 || mm == 3 || mm == 5 || mm == 7 || mm == 8 || mm == 10 || mm == 12) {
        ...
        if ((dd >= 1 && dd <= 28) || (dd == 29 && isLeap)) isValid = 1;
    }
    if (isValid) {
...
<img width="617" height="97" alt="image" src="https://github.com/user-attachments/assets/f8e54432-aecb-413b-b158-f20aa150892b" />
...
<img width="363" height="176" alt="image" src="https://github.com/user-attachments/assets/b2043e3f-fe2b-4f77-a060-4fdbfbbd0f79" />
